...
import { Box, Bird, Cat, Rabbit, Users, Code2, Wand2, Hammer, FolderOpen, ChevronUp, FileJson, History, Play, Pause, Info, Wrench, Loader2, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
        ...
        <div className="pointer-events-auto flex flex-col gap-2">
            ...
            >
                ...
                <DropdownItem onClick={onPromptCreate} icon={<Wand2 size={16}/>} label="New build (Text)" highlight />
                <DropdownItem onClick={onImageCreate} icon={<ImageIcon size={16}/>} label="New build (Image)" highlight />
